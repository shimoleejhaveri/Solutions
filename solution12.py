...
has new weight y-x. At the end, there is at most 1 stone left.  Return the weight 
...
Hint 1:
Simulate the process. We can do it with a heap, or by sorting some list of stones 
every time we take a turn.
"""
